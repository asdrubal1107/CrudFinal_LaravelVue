...
<div id="app">
    ...
    @include('layouts.plantilla.sidebar')<!-- /# sidebar -->
    
    @include('layouts.plantilla.header')<!-- /# header -->
    ...
    <script src="js/app.js"></script><!--Incluimos el app que nos permitira trabajar con vue--->
